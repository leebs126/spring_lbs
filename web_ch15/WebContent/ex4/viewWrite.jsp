 ...
 function fn_modify(_param,obj){
	// alert(obj.value);
	 ...
	 $.ajax({
			...
			url:"${serverUrl}",
			data: {action:"modWrite",param:_param,value:_value},
...
<body>
  ...
  <tr>
   ...
   <td >
    ...
    <td>
      <input type="button" value="수정" onClick="fn_modify('author',frmCon.t_author)" id="b_author"   disabled />
    </td>   
  </tr>
  <tr>
   <td width=150 align=center bgcolor=#FF9933>
   ...
   <td>
    ...
    <td>
      <input type="button" value="수정" onClick="fn_modify('title',frmCon.t_title)" id="b_title"   disabled />
    </td> 
  </tr>
  <tr>
   <td width=150 align=center bgcolor=#FF9933>
   ...
   <td>
    ...
    <td>
      <input type="button" value="수정" onClick="fn_modify('content',frmCon.t_content)" id="b_content"   disabled />
    </td>  
  </tr>
 <tr>
   ...
   <td>
    ...
    <td>
      <input type="button" value="수정" onClick="fn_modify('email',frmCon.t_email)" id="b_email"   disabled />
    </td>  
  </tr>
...
<tr>
   ...
   <td>
    ...
    <td>
      <input type="button" value="수정" onClick="fn_modify('passwd',frmCon.t_passwd)" id="b_passwd"   disabled />
    </td>  
  </tr>
  <tr>
   <td width=20% align=center bgcolor=#FF9933>
  ...
  <tr >
   <td colspan=2 align=center>
    ...
    <input type=button value="삭제하기" onClick="fn_delente(frmCon)">
