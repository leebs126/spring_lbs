<%@ page language="java" contentType="text/html; charset=UTF-8"
         import="java.io.*,java.util.*,com.spring.member.vo.MemberBean"
         pageEncoding="UTF-8"
         isELIgnored="false" %>
...
%>  
<c:url  var="serverUrl" value="${pageContext.request.contextPath}" />
...
<c:forEach  var="mem" items="${memList }" >
   <tr align="center">
     ...
     <td>${mem.weight}</td>     
     <td>${mem.height}</td> 
     <td><a href="./delMember.do?id=${mem.id }">삭제하기</a></td>      
   </tr>
   </c:forEach>
</c:when>
</c:choose>
