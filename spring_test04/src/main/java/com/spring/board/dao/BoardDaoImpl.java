...
public class BoardDaoImpl implements BoardDao{
   ...
   private SqlSession sqlSession;
	public ArrayList selectWriteList(HashMap map){
		ArrayList<WriteBean> writeList=(ArrayList) sqlSession.selectList("mapper.board.selectWriteList",map);
		return writeList;
	}
	...
	public ArrayList<WriteBean> getGroupIdList(int group_id){
		ArrayList<WriteBean> writeList=(ArrayList) sqlSession.selectList("mapper.board.getGroupIdList",group_id);
		return writeList;
	}
