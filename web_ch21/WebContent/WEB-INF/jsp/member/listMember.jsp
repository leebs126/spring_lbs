...
%>  
<c:url  var="server" value="http://localhost:8090/web_ch21/member" />
...
function moveInsert() {
	document.listFrm.action ="http://localhost:8090/web_ch21/member/memberForm.do";
...
<c:forEach  var="mem" items="${memList }" >
   <tr align="center">
     ...
     <td>${mem.weight}</td>     
     <td>${mem.height}</td> 
     <td><a href="${pageContext.request.contextPath}/member/deleteMember.do?id=${mem.id }">삭제하기</a></td>      
   </tr>
   </c:forEach>
</c:when>
</c:choose>
